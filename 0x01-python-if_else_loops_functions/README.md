...
2. Write a program that prints the ASCII alphabet, in lowercase, not followed by a new line Print all the letters except q and e.
3. Write a program that prints all numbers from 0 to 98 in decimal and in hexadecimal (as in the following example)
4. Write a program that prints numbers from 0 to 99.
